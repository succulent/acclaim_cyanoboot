...
ALL = u-boot.srec u-boot.bin System.map flashing_boot_emmc.img flashing_boot.img
...
flashing_boot_emmc.img:  u-boot.bin
		python ./tools/build_nt_2ndboot_img.py -f -o $@ $<

flashing_boot.img:  u-boot.bin
		python ./tools/build_nt_2ndboot_img.py -o $@ $<
...
clobber:	clean
	find . -type f \( -name .depend \
		-o -name '*.srec' -o -name '*.bin' -o -name '*.img' \) \
		-print0 \
		| xargs -0 rm -f
